...
public class ControlView extends RelativeLayout implements ViewAction, ITheme {
    ...
    //切换大小屏相关
    protected AliyunScreenMode mAliyunScreenMode = AliyunScreenMode.Small;
    //全屏/小屏按钮
...
//            mTitleMore.setVisibility(GONE);
    ...
    public void setVisibility(int visibility) {
        ...
        if (listener != null) {
            listener.onShowStatus(visibility == View.VISIBLE && mAliyunScreenMode == AliyunScreenMode.Small);
        }
    }

    private IVisibilityListener listener;

    public void setIVisibilityListener(IVisibilityListener listener) {
        this.listener = listener;
    }

    public interface IVisibilityListener {
        void onShowStatus(boolean isShow);
    }
}
